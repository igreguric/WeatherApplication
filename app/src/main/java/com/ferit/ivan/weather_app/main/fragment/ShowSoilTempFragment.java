...
/**
 * Created by ivan on 9/15/16.
 */
public class ShowSoilTempFragment extends BaseFragment implements View.OnClickListener {

    public static final String BUNDLE_DATA = "bundle_data";

    private Data mWeatherData;

    private TextView mSoilTempTxt;
    private TextView mDateTxt;

    public static Fragment newInstance(Data data) {
        Fragment fragment = new ShowSoilTempFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_soiltemp_data, container, false);
    }
    ...
    protected void prepareUI(@NonNull View layoutView) {
        mSoilTempTxt = (TextView) layoutView.findViewById(R.id.s3);
    ...
    private void setUiData() {
        ...
        mSoilTempTxt.setText(mWeatherData.getS3());
