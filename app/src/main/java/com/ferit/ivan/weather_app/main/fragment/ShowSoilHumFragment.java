 ...
 */
public class ShowSoilHumFragment extends BaseFragment implements View.OnClickListener {

    public static final String BUNDLE_DATA = "bundle_data";

    private Data mWeatherData;

    private TextView mSoilHumTxt;
    private TextView mDateTxt;

    public static Fragment newInstance(Data data) {
        Fragment fragment = new ShowSoilHumFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_soilhum_data, container, false);
    }
    ...
    protected void prepareUI(@NonNull View layoutView) {
        mSoilHumTxt = (TextView) layoutView.findViewById(R.id.s4);
    ...
    private void setUiData() {
        ...
        mSoilHumTxt.setText(mWeatherData.getS4());
